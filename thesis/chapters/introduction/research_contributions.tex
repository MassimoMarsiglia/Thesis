...
The framework further contributes methodological insights into the application of Transformer-based retrieval architectures for regulatory entity linking, including multi-stage retrieval approaches that combine efficient candidate generation with semantic reranking. Additionally, this thesis investigates the role of data augmentation strategies for improving the robustness and scalability of regulatory entity linking in settings where manually annotated legal data is limited.
