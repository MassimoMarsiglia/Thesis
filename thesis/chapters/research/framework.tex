...
\begin{enumerate}
    ...
    \item Two-stage regulatory document entity linking through candidate retrieval and semantic reranking
\end{enumerate}
...
\caption{Conceptual overview of the proposed regulatory document entity linking framework.}
...
The combination of efficient candidate generation and interaction-based reranking provides a scalable approach for regulatory document entity linking while maintaining high semantic precision.
