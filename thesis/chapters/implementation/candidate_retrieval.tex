...
the complete regulatory document entity collection.
...
linked regulatory document entity is retained as the positive candidate, while highly
...
reference paired with its corresponding regulatory document entity, while negative pairs
